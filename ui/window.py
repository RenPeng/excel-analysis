...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.sourceFileChooseReView_4 = QtWidgets.QLabel(self.frame_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.sourceFileChooseReView_4.sizePolicy().hasHeightForWidth())
        self.sourceFileChooseReView_4.setSizePolicy(sizePolicy)
        self.sourceFileChooseReView_4.setObjectName("sourceFileChooseReView_4")
        self.horizontalLayout_15.addWidget(self.sourceFileChooseReView_4)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.step1ConfigFileChooseRV.setText(_translate("MainWindow", "选择Excel文件"))
        ...
        self.step1SourceFileChooseRV.setText(_translate("MainWindow", "选择Excel文件"))
        self.step1SourceDataSheetSelect.setItemText(0, _translate("MainWindow", "选择月份数据"))
        self.step1ExportBT.setText(_translate("MainWindow", "导出"))
        self.step1ProcessBT.setText(_translate("MainWindow", "处理"))
        self.sourceFileChooseReView_4.setText(_translate("MainWindow", "任务列表："))
        self.label_12.setText(_translate("MainWindow", "【订单状态】为取消的订单。"))
